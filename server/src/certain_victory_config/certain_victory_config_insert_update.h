#ifndef __CERTAIN_VICTORY_CONFIG_INSERT_UPDATE_H__
#define __CERTAIN_VICTORY_CONFIG_INSERT_UPDATE_H__
class CertainVictoryConfigInsertUpdateRequest
{
public:
	CertainVictoryConfigInsertUpdateRequest(const string& json) {
...
class CertainVictoryConfigInsertUpdateResponse
{
public:
	CertainVictoryConfigInsertUpdateResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
