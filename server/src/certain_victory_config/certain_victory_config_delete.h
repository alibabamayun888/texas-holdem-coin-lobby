#ifndef __CERTAIN_VICTORY_CONFIG_DELETE_H__
#define __CERTAIN_VICTORY_CONFIG_DELETE_H__
class CertainVictoryConfigDeleteRequest
{
public:
	CertainVictoryConfigDeleteRequest(const string& json) {
...
class CertainVictoryConfigDeleteResponse
{
public:
	CertainVictoryConfigDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
